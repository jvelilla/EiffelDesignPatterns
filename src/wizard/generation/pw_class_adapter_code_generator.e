indexing
	...
	description:
		...
		"Class adapter pattern code generator"
...
class PW_CLASS_ADAPTER_CODE_GENERATOR
...
feature -- Access
	...
	pattern_info: PW_CLASS_ADAPTER_INFORMATION
...
feature {NONE} -- Implementation (Code generation)
	...
	generate_ace_file is
		...
		do
			...
			generate_code (project_directory + class_adapter_ace_name + ".ace" , pattern_delivery_directory + class_adapter_ace_file_name, some_changes)
		end
	...
	generate_root_class is
		...
		do
			...
			generate_code (project_directory + default_root_class_name.as_lower + ".e", pattern_delivery_directory + class_adapter_root_class_file_name, some_changes)
		end
	...
	generate_target_class is
		...
		do
			...
			generate_code (project_directory + pattern_info.target_class_name.as_lower + ".e", pattern_delivery_directory + class_adapter_target_class_file_name, some_changes)
		end
	...
	generate_adaptee_class is
		...
		do
			...
			generate_code (project_directory + pattern_info.adaptee_class_name.as_lower + ".e", pattern_delivery_directory + class_adapter_adaptee_class_file_name, some_changes)
		end
	...
	generate_adapter_class is
		...
		do
			...
			generate_code (project_directory + pattern_info.adapter_class_name.as_lower + ".e", pattern_delivery_directory + class_adapter_class_file_name, some_changes)
		end
