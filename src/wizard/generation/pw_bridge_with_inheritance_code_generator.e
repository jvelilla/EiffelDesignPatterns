note
	...
	description:
		...
		"Bridge with inheritance pattern code generator"
...
class PW_BRIDGE_WITH_INHERITANCE_CODE_GENERATOR
...
feature -- Access
	...
	pattern_info: PW_BRIDGE_WITH_INHERITANCE_INFORMATION
...
feature {NONE} -- Implementation (Code generation)
	...
	generate_ace_file
		...
		do
			...
			generate_code (project_directory + bridge_with_inheritance_ace_name + ".ace" , pattern_delivery_directory + bridge_with_inheritance_ace_file_name, some_changes)
		end
	...
	generate_root_class
		...
		do
			...
			generate_code (project_directory + other_root_class_name.as_lower + ".e", pattern_delivery_directory + bridge_with_inheritance_root_class_file_name, some_changes)
		end
	...
	generate_application_class
		...
		do
			...
			generate_code (project_directory + pattern_info.application_class_name.as_lower + ".e", pattern_delivery_directory + bridge_with_inheritance_class_file_name, some_changes)
		end
	...
	generate_descendant_application_classes
		...
		do
			...
			from descendants_name.start until descendants_name.after loop
				...
				generate_code (project_directory + a_name.as_lower + ".e", pattern_delivery_directory + bridge_with_inheritance_descendant_class_file_name, some_changes)
				descendants_name.forth
			end
		end
	...
	generate_application_implementation_class
		...
		do
			...
			generate_code (project_directory + pattern_info.application_implementation_class_name.as_lower + ".e", pattern_delivery_directory + bridge_with_inheritance_implementation_class_file_name, some_changes)
		end
	...
	generate_descendant_application_implementation_classes
		...
		do
			...
			from descendants_name.start until descendants_name.after loop
				...
				generate_code (project_directory + a_name.as_lower + ".e", pattern_delivery_directory + bridge_with_inheritance_descendant_implementation_class_file_name, some_changes)
				descendants_name.forth
			end
		end
