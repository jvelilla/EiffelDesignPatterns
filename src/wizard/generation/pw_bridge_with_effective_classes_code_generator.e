...
feature {NONE} -- Implementation (Code generation)
	...
	generate_ace_file
		...
		do
			...
			generate_code (project_directory + bridge_with_effective_classes_ace_name + ".ecf" , pattern_delivery_directory + bridge_with_effective_classes_ace_file_name, some_changes)
		end
