note
	...
	description:
		...
		"Class adapter pattern-specific GUI part of the Pattern Wizard window"
...
class PW_CLASS_ADAPTER_VERTICAL_BOX
...
feature {NONE} -- Initialization
	...
	initialize_pattern_components 
		...
		do
			...
			create pattern_properties_frame.make_with_name_and_text (class_adapter_pattern_name, pattern_delivery_directory + class_adapter_class_diagram_file_name, pattern_properties_frame_text)
		end

feature {PW_INITIAL_WINDOW_IMP} -- Implementation (GUI components)

	pattern_properties_frame: PW_CLASS_ADAPTER_PROPERTY_SELECTOR
