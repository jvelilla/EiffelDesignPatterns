indexing
	...
	description:
		"[
			...
			Bridge pattern implemented with effective classes only
		]"
...
class PW_BRIDGE_WITH_EFFECTIVE_CLASSES_PROPERTY_SELECTOR
...
feature {NONE} -- Initialization
	...
	initialize_pattern_components is
		...
		do
			create notebook
			create application_frame.make_with_info_and_text (creation_procedure_name_label_text,
